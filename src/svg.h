...
/*  Marca a âncora (canto sudeste) da quadra removida com um X vermelho.  */
void svg_marcar_remocao(double x, double y);

/*  Escreve o número de moradores de cada face próximo ao limite da face
    e o total no centro da quadra.
*/
...
/*  Marca o endereço de destino de uma mudança com um quadrado vermelho
    contendo o cpf em fonte minúscula.
*/
