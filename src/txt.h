...
/*  Informa no TXT o CPF e nome de um morador que passou a ser sem-teto
    devido à remoção de sua quadra (comando rq).
*/
...
/*  Reporta todos os dados de um habitante (comando h?).
    Se for morador, reporta também o endereço.
*/
void txt_habitante(const Habitante* hab);

/*  Reporta os dados do habitante falecido (comando rip).
    Se for morador, reporta também o endereço.
*/
